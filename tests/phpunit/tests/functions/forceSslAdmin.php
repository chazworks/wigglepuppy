...
class Tests_Functions_ForceSslAdmin extends WP_UnitTestCase
{
    ...
    public function data_should_return_expected_value_when_various_inputs_are_passed()
    {
        return [
            ...
            'first_call_true'             => [ true, false, true ],
            'first_call_false'            => [ false, false, false ],
            'first_call_non_empty_string' => [ 'some string', false, true ],
            'empty_string'                => [ '', false, false ],
            'first_call_integer_1'        => [ 1, false, true ],
            'integer_0'                   => [ 0, false, false ],
        ];
    }
