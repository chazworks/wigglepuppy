...
class Tests_HtmlApi_WpHtmlProcessorSemanticRules extends WP_UnitTestCase
{
    ...
    public function test_in_body_article_group_can_nest_inside_itself($tag_name)
    {
        ...
        $this->assertSame(
            [ 'HTML', 'BODY', 'DIV', $tag_name, $tag_name, 'SPAN', $tag_name ],
            $processor->get_breadcrumbs(),
    ...
    public function test_in_body_button_with_no_button_in_scope()
    {
        ...
        $this->assertSame([ 'HTML', 'BODY', 'DIV', 'P', 'BUTTON' ], $processor->get_breadcrumbs(), 'Failed to produce expected DOM nesting for first button.');
        ...
        $this->assertSame([ 'HTML', 'BODY', 'BUTTON' ], $processor->get_breadcrumbs(), 'Failed to produce expected DOM nesting for second button.');
    }
    ...
    public function test_in_body_button_with_button_in_scope_as_parent()
    {
        ...
        $this->assertTrue($processor->next_tag('BUTTON'), 'Could not find expected second button.');
        $this->assertTrue($processor->get_attribute('two'), 'Failed to match expected attribute on second button.');
        $this->assertSame([ 'HTML', 'BODY', 'DIV', 'P', 'BUTTON' ], $processor->get_breadcrumbs(), 'Failed to produce expected DOM nesting for second button.');
        ...
        $this->assertSame([ 'HTML', 'BODY', 'BUTTON' ], $processor->get_breadcrumbs(), 'Failed to produce expected DOM nesting for third button.');
    }
    ...
    public function test_in_body_button_with_button_in_scope_as_ancestor()
    {
        ...
        $this->assertTrue($processor->next_tag('BUTTON'), 'Could not find expected first button.');
        $this->assertTrue($processor->get_attribute('one'), 'Failed to match expected attribute on first button.');
        $this->assertSame([ 'HTML', 'BODY', 'DIV', 'BUTTON' ], $processor->get_breadcrumbs(), 'Failed to produce expected DOM nesting for first button.');
        ...
        $this->assertTrue($processor->next_tag('BUTTON'), 'Could not find expected second button.');
        $this->assertTrue($processor->get_attribute('two'), 'Failed to match expected attribute on second button.');
        $this->assertSame([ 'HTML', 'BODY', 'DIV', 'BUTTON' ], $processor->get_breadcrumbs(), 'Failed to produce expected DOM nesting for second button.');
    ...
    public function test_in_body_any_other_end_tag_with_unclosed_special_element()
    {
        ...
        $this->assertSame([ 'HTML', 'BODY', 'DIV', 'SPAN', 'P' ], $processor->get_breadcrumbs(), 'Failed to produce expected DOM nesting.');
        ...
        $this->assertSame([ 'HTML', 'BODY', 'DIV', 'SPAN', 'DIV' ], $processor->get_breadcrumbs(), 'Failed to produce expected DOM nesting: SPAN should still be open and DIV should be its child.');
    }
    ...
    public function test_in_body_any_other_end_tag_with_unclosed_non_special_element()
    {
        ...
        $this->assertSame([ 'HTML', 'BODY', 'DIV', 'SPAN', 'CODE' ], $processor->get_breadcrumbs(), 'Failed to produce expected DOM nesting.');
        ...
        $this->assertSame([ 'HTML', 'BODY', 'DIV' ], $processor->get_breadcrumbs(), 'Failed to advance past CODE tag to expected DIV opener.');

        $this->assertTrue($processor->next_tag(), 'Failed to advance past SPAN closer to expected DIV opener.');
        $this->assertSame('DIV', $processor->get_tag(), "Expected to find DIV element, but found {$processor->get_tag()} instead.");
        $this->assertSame([ 'HTML', 'BODY', 'DIV', 'DIV' ], $processor->get_breadcrumbs(), 'Failed to produce expected DOM nesting: SPAN should be closed and DIV should be its sibling.');
    }
    ...
    public function test_table_form_element_immediately_popped()
    {
        ...
        $this->assertsame([ 'HTML', 'BODY', 'TABLE', '#comment' ], $processor->get_breadcrumbs());
    }
}
