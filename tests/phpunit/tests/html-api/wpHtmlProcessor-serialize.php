...
class Tests_HtmlApi_WpHtmlProcessor_Serialize extends WP_UnitTestCase
{
    ...
    public static function data_provider_serialize_doctype()
    {
        return [
            ...
            'HTML5'                      => [ '<!DOCTYPE html>', '<!DOCTYPE html>' ],
            'Strange name'               => [ '<!DOCTYPE WordPress>', '<!DOCTYPE wordpress>' ],
            'With public'                => [ '<!DOCTYPE html PUBLIC "x">', '<!DOCTYPE html PUBLIC "x">' ],
            'With system'                => [ '<!DOCTYPE html SYSTEM "y">', '<!DOCTYPE html SYSTEM "y">' ],
            'With public and system'     => [ '<!DOCTYPE html PUBLIC "x" "y">', '<!DOCTYPE html PUBLIC "x" "y">' ],
            'Weird casing'               => [ '<!docType HtmL pubLIc\'xxx\'"yyy" all this is ignored>', '<!DOCTYPE html PUBLIC "xxx" "yyy">' ],
            'Single quotes in public ID' => [ '<!DOCTYPE html PUBLIC "\'quoted\'">', '<!DOCTYPE html PUBLIC "\'quoted\'">' ],
            'Double quotes in public ID' => [ '<!DOCTYPE html PUBLIC \'"quoted"\'\>', '<!DOCTYPE html PUBLIC \'"quoted"\'>' ],
            'Single quotes in system ID' => [ '<!DOCTYPE html SYSTEM "\'quoted\'">', '<!DOCTYPE html SYSTEM "\'quoted\'">' ],
            'Double quotes in system ID' => [ '<!DOCTYPE html SYSTEM \'"quoted"\'\>', '<!DOCTYPE html SYSTEM \'"quoted"\'>' ],
        ];
    }
}
