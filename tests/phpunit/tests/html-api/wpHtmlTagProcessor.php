...
{
    public const HTML_SIMPLE       = '<div id="first"><span id="second">Text</span></div>';
    public const HTML_WITH_CLASSES = '<div class="main with-border" id="first"><span class="not-main bold with-border" id="second">Text</span></div>';
    public const HTML_MALFORMED    = '<div><span class="d-md-none" Notifications</span><span class="d-none d-md-inline">Back to notifications</span></div>';
...
HTML
    ...
    public static function data_alphabet_by_characters_uppercase()
    {
        foreach (self::data_alphabet_by_characters_lowercase() as $data) {
            yield strtoupper($data[0]) => [ strtoupper($data[0]) ];
        }
    }
}
