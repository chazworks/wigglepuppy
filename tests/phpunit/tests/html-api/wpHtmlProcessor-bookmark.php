...
class Tests_HtmlApi_WpHtmlProcessor_Bookmark extends WP_UnitTestCase
{
    ...
    public function test_seek_back_from_foreign_content(callable $factory)
    {
        ...
        $this->assertSame([ 'HTML', 'BODY', 'CUSTOM-ELEMENT', 'SVG', 'RECT' ], $processor->get_breadcrumbs());
    ...
    {
        return [
            'Full parser'     => [ [ WP_HTML_Processor::class, 'create_full_parser' ] ],
            'Fragment parser' => [ [ WP_HTML_Processor::class, 'create_fragment' ] ],
        ];
    }
