...
class Tests_Post_TruncatePostSlug extends WP_UnitTestCase
{
    ...
    public function data_truncate_post_slug_should_truncate()
    {
        return [
            ...
            'a slug that is too long and ends with a dash' => [
                'slug'     => 'truncated-slug',
                'length'   => 10,
                'expected' => 'truncated',
                'message'  => '"truncated-slug" should have been truncated to "truncated".',
            ...
            'URL-encoded characters and "length" includes the first URL-encoded character' => [
                'slug'     => 'myslug%2F',
                'length'   => 7,
                'expected' => 'myslug',
                'message'  => '"myslug%2F" should have been truncated to "myslug".',
            ],
            'URL-encoded characters and "length" includes the second URL-encoded character' => [
                'slug'     => 'myslug%2F',
                'length'   => 8,
                'expected' => 'myslug',
                'message'  => '"myslug%2F" should have been truncated to "myslug".',
            ],
            'URL-encoded characters and "length" includes the third URL-encoded character' => [
                'slug'     => 'myslug%2F',
                'length'   => 9,
                'expected' => 'myslug%2F',
            ...
            'URL-encoded accent characters and "length" includes the first URL-encoded character' => [
                'slug'     => 'myslug%C4%85',
                'length'   => 7,
                'expected' => 'myslug',
                'message'  => '"myslug%C4%85" should have been truncated to "myslug".',
            ],
            'URL-encoded accent characters and "length" includes the second URL-encoded character' => [
                'slug'     => 'myslug%C4%85',
                'length'   => 8,
                'expected' => 'myslug',
                'message'  => '"myslug%C4%85" should have been truncated to "myslug".',
            ],
            'URL-encoded accent characters and "length" includes the third URL-encoded character' => [
                'slug'     => 'myslug%C4%85',
                'length'   => 9,
                'expected' => 'myslug',
                'message'  => '"myslug%C4%85" should have been truncated to "myslug".',
            ],
            'URL-encoded accent characters and "length" includes the fourth URL-encoded character' => [
                'slug'     => 'myslug%C4%85',
                'length'   => 10,
                'expected' => 'myslug',
                'message'  => '"myslug%C4%85" should have been truncated to "myslug".',
            ],
            'URL-encoded accent characters and "length" includes the fifth URL-encoded character' => [
                'slug'     => 'myslug%C4%85',
                'length'   => 11,
                'expected' => 'myslug',
                'message'  => '"myslug%C4%85" should have been truncated to "myslug".',
