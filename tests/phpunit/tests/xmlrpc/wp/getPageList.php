...
class Tests_XMLRPC_wp_getPageList extends WP_XMLRPC_UnitTestCase
{
    ...
    {
        $result = $this->myxmlrpcserver->wp_getPageList([ 1, 'username', 'password' ]);
    ...
    public function test_incapable_user()
    {
        ...
        $result = $this->myxmlrpcserver->wp_getPageList([ 1, 'contributor', 'contributor' ]);
        $this->assertIXRError($result);
    ...
    public function test_date()
    {
        ...
        $results = $this->myxmlrpcserver->wp_getPageList([ 1, 'editor', 'editor' ]);
