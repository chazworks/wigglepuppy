...
class Tests_Block_Supports_Aria_Label extends WP_UnitTestCase
{
     ...
     */
    private function register_aria_label_block_with_support($block_name, $supports = [])
    {
    ...
    {
        return [
            'aria-label attribute is applied' => [
                'support'  => true,
                'value'    => 'Label',
                'expected' => [ 'aria-label' => 'Label' ],
            ],
            'aria-label attribute is not applied if block does not support it' => [
                'support'  => false,
                'value'    => 'Label',
                'expected' => [],
            ],
