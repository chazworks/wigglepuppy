...
class WP_Test_REST_Application_Passwords_Controller extends WP_Test_REST_Controller_Testcase
{
    ...
    public function test_get_items_self_user_id_subscriber()
    {
        ...
        list(, $item) = WP_Application_Passwords::create_new_application_password(self::$subscriber_id, [ 'name' => 'App' ]);
    ...
    public function test_create_item_self_user_id_admin()
    {
        ...
        $request->set_body_params([ 'name' => 'App' ]);
        $response = rest_do_request($request);
    ...
    public function test_update_item()
    {
        ...
        $request->set_body_params([ 'name' => 'New App' ]);
        $response = rest_do_request($request);
        $this->assertSame(200, $response->get_status());
    ...
    public function test_update_item_cannot_overwrite_app_id()
    {
        ...
        $uuid    = $item['uuid'];
        $request = new WP_REST_Request('PUT', '/wp/v2/users/me/application-passwords/' . $uuid);
        $request->set_body_params([ 'app_id' => wp_generate_uuid4() ]);
        $response = rest_do_request($request);
    ...
    {
        wp_set_current_user(self::$admin);
        WP_Application_Passwords::create_new_application_password(self::$admin, [ 'name' => 'App 1' ]);
        WP_Application_Passwords::create_new_application_password(self::$admin, [ 'name' => 'App 2' ]);
    ...
    {
        wp_set_current_user(self::$admin);
        WP_Application_Passwords::create_new_application_password(self::$admin, [ 'name' => 'App' ]);
    ...
    {
        wp_set_current_user(self::$subscriber_id);
        WP_Application_Passwords::create_new_application_password(self::$subscriber_id, [ 'name' => 'App' ]);
    ...
    {
        wp_set_current_user(self::$admin);
        list($password, $item) = WP_Application_Passwords::create_new_application_password(self::$admin, [ 'name' => 'App' ]);
    ...
    {
        return [
            'availability not forced'   => [
                'expected' => 'default',
            ],
            'availability forced true'  => [
                'expected' => true,
    ...
    {
        list($password, $item) = WP_Application_Passwords::create_new_application_password(self::$admin, [ 'name' => 'Test' ]);
