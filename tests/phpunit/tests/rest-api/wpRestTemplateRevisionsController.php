...
class Tests_REST_wpRestTemplateRevisionsController extends WP_Test_REST_Controller_Testcase
{
     ...
     * @var string
     */
    public const TEST_THEME = 'block-theme';

    /**
     * @var string
     */
    public const TEMPLATE_NAME = 'my_template';

    /**
     * @var string
     */
    public const TEMPLATE_NAME_2 = 'my_template_2';

    /**
     * @var string
     */
    public const TEMPLATE_PART_NAME = 'my_template_part';

    /**
     * @var string
     */
    public const TEMPLATE_PART_NAME_2 = 'my_template_part_2';

    /**
     * @var string
     */
    public const TEMPLATE_POST_TYPE = 'wp_template';

    /**
     * @var string
     */
    public const TEMPLATE_PART_POST_TYPE = 'wp_template_part';
     ...
     * @var array
     */
    private static $template_revisions = [];

    /**
     * @var array
     */
    private static $template_part_revisions = [];
    ...
    {
        return [
            'templates'      => [ 'templates', self::TEST_THEME . '//' . self::TEMPLATE_NAME ],
            'template parts' => [ 'template-parts', self::TEST_THEME . '//' . self::TEMPLATE_PART_NAME ],
        ];
    }
    ...
    {
        return [
            'templates'      => [ 'template_post', 'templates', self::TEST_THEME . '//' . self::TEMPLATE_NAME ],
            'template parts' => [ 'template_part_post', 'template-parts', self::TEST_THEME . '//' . self::TEMPLATE_PART_NAME ],
        ];
    }
    /**
     * @ticket 56481
    ...
    {
        return [
            'templates, GET request'       => [ 'templates', self::TEST_THEME . '//' . self::TEMPLATE_NAME, 'GET' ],
            'templates, HEAD request'      => [ 'templates', self::TEST_THEME . '//' . self::TEMPLATE_NAME, 'HEAD' ],
            'template parts, GET request'  => [ 'template-parts', self::TEST_THEME . '//' . self::TEMPLATE_PART_NAME, 'GET' ],
            'template parts, HEAD request' => [ 'template-parts', self::TEST_THEME . '//' . self::TEMPLATE_PART_NAME, 'HEAD' ],
        ];
    }
    ...
    {
        return [
            'templates'      => [ 'templates', self::TEST_THEME . '//page-home' ],
            'template parts' => [ 'template-parts', self::TEST_THEME . '//small-header' ],
        ];
    }
    ...
    public function test_get_item_with_data_provider($parent_post_property_name, $rest_base, $template_id)
    {
        ...
        $revisions   = wp_get_post_revisions($parent_post, [ 'fields' => 'ids' ]);
    ...
    {
        return [
            'templates, GET request'       => [ 'template_post', 'templates', 'GET' ],
            'templates, HEAD request'      => [ 'template_post', 'templates', 'HEAD' ],
            'template parts, GET request'  => [ 'template_part_post', 'template-parts', 'GET' ],
            'template parts, HEAD request' => [ 'template_part_post', 'template-parts', 'HEAD' ],
        ];
    }
     ...
     */
    public function test_get_item_schema_with_data_provider($rest_base, $template_id, $properties_count, $additional_properties = [])
    {
        $request    = new WP_REST_Request('OPTIONS', '/wp/v2/' . $rest_base . '/' . $template_id . '/revisions');
        $response   = rest_get_server()->dispatch($request);
        $data       = $response->get_data();
