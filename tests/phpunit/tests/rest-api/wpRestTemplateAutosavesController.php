...
class Tests_REST_wpRestTemplateAutosavesController extends WP_Test_REST_Controller_Testcase
{
     ...
     * @var string
     */
    public const PARENT_POST_TYPE = 'wp_template';
    ...
    public function data_create_item_with_data_provider()
    {
        return [
            'templates'     => [ 'templates', self::TEST_THEME . '//' . self::TEMPLATE_NAME ],
            'template part' => [ 'template-parts', self::TEST_THEME . '//' . self::TEMPLATE_PART_NAME ],
        ];
    }
    ...
    {
        return [
            'template'      => [ 'templates', self::TEST_THEME . '//' . self::TEMPLATE_NAME ],
            'template part' => [ 'template-parts', self::TEST_THEME . '//' . self::TEMPLATE_PART_NAME ],
        ];
    }
