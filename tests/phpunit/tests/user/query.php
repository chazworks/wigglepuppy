...
class Tests_User_Query extends WP_UnitTestCase
{
    ...
    public function test_include_single()
    {
        ...
        $this->assertEqualSets([ self::$author_ids[0] ], $ids);
    }
    ...
    public function test_include_comma_separated()
    {
        ...
        $this->assertEqualSets([ self::$author_ids[0], self::$author_ids[2] ], $ids);
    }
    ...
    public function test_get_all_primed_users()
    {
        ...
        add_filter('update_user_metadata_cache', [ $filter, 'filter' ], 10, 2);
    ...
    public function test_orderby_include()
    {
        ...
        $this->assertEquals([ self::$author_ids[1], self::$author_ids[0], self::$author_ids[3] ], $q->get_results());
    }
    ...
    public function test_roles_and_caps_should_be_populated_for_default_value_of_blog_id()
    {
        ...
        $this->assertSame([ 'author' => true ], $user->caps);
    }
    ...
    public function test_has_published_posts_with_value_true_should_show_authors_of_posts_in_public_post_types()
    {
        ...
        register_post_type('wptests_pt_private', [ 'public' => false ]);
    ...
    public function test_query_vars_should_be_filled_in_after_pre_get_users()
    {
        ...
        remove_action('pre_get_users', [ $this, 'filter_pre_get_users_args' ]);
    ...
    {
        $users = new WP_User_Query([ 'role' => [ 'subscriber', 'editor' ] ]);
        $users = $users->get_results();
    ...
    {
        $users = new WP_User_Query([ 'role__in' => [ 'subscriber', 'editor', 'administrator' ] ]);
        $users = $users->get_results();
    ...
    {
        wp_roles()->add_role('role_1', 'Role 1', [ 'role_1_cap' => true ]);
        wp_roles()->add_role('role_2', 'Role 2', [ 'role_2_cap' => true ]);
