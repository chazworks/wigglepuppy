...
class Test_Query_CacheResults extends WP_UnitTestCase
{
    ...
    public function test_post_parent_in_order_by_clauses_are_not_normalized()
    {
        ...
        $post_names   = [ 'doctor-dillamond', 'elphaba', 'fiyero', 'glinda', 'the-wizard-of-oz' ];
        $child_pages  = [];
        ...
        $this->assertSame([ 'doctor-dillamond', 'elphaba', 'fiyero', 'glinda', 'the-wizard-of-oz' ], wp_list_pluck($query1->posts, 'post_name'), 'Query one posts should be in alphabetical order');
        $this->assertSame([ 'the-wizard-of-oz', 'glinda', 'fiyero', 'elphaba', 'doctor-dillamond' ], wp_list_pluck($query2->posts, 'post_name'), 'Query two posts should be in reverse alphabetical order.');
        // Test the posts are the same sets.
        $this->assertSameSets(wp_list_pluck($query1->posts, 'ID'), wp_list_pluck($query2->posts, 'ID'), 'Query one posts should match the set of query two posts.');
    }
    ...
    {
        global $wpdb;
        $post_names = [ 'doctor-dillamond', 'elphaba', 'glinda', 'the-wizard-of-oz' ];
        $posts      = [];
        ...
        // Test the posts are returned in the correct order.
        $this->assertSame([ 'doctor-dillamond', 'elphaba', 'glinda', 'the-wizard-of-oz' ], wp_list_pluck($query1->posts, 'post_name'), 'Query one posts should be in alphabetical order');
        $this->assertSame([ 'the-wizard-of-oz', 'glinda', 'elphaba', 'doctor-dillamond' ], wp_list_pluck($query2->posts, 'post_name'), 'Query two posts should be in reverse alphabetical order.');
        // Test the posts are the same sets.
        $this->assertSameSets(wp_list_pluck($query1->posts, 'ID'), wp_list_pluck($query2->posts, 'ID'), 'Query one posts should match the set of query two posts.');
    }
    ...
    public function data_query_cache_duplicate()
    {
        return [
            ...
            'non-unique post type'                         => [
                'query_vars1' => [ 'post_type' => [ 'post', 'page' ] ],
                'query_vars2' => [ 'post_type' => [ 'page', 'post', 'page' ] ],
            ],
            'post status array'                            => [
            ...
            'non-unique post status'                       => [
                'query_vars1' => [ 'post_status' => [ 'draft', 'publish' ] ],
                'query_vars2' => [ 'post_status' => [ 'draft', 'publish', 'draft' ] ],
            ],
            'post id int vs string'                        => [
                'query_vars1' => [ 'p' => '1' ],
                'query_vars2' => [ 'p' => 1 ],
            ],
            'page id int vs string'                        => [
                'query_vars1' => [ 'page_id' => '2' ],
                'query_vars2' => [ 'page_id' => 2 ],
            ],
            'attachment id int vs string'                  => [
                'query_vars1' => [ 'attachment_id' => '3' ],
                'query_vars2' => [ 'attachment_id' => 3 ],
            ],
            'date and time values int vs string'           => [
                'query_vars1' => [
                    'year'     => '2013',
                    'monthnum' => '12',
                    'day'      => '12',
            ...
            'offset value int vs string'                   => [
                'query_vars1' => [ 'offset' => '5' ],
                'query_vars2' => [ 'offset' => 5 ],
            ],
            'posts per page value int vs string'           => [
                'query_vars1' => [ 'posts_per_page' => '5' ],
                'query_vars2' => [ 'posts_per_page' => 5 ],
            ],
            'paged value int vs string'                    => [
                'query_vars1' => [ 'paged' => '2' ],
                'query_vars2' => [ 'paged' => 2 ],
            ],
            'menu_order value int vs string'               => [
                'query_vars1' => [ 'menu_order' => '2' ],
                'query_vars2' => [ 'menu_order' => 2 ],
            ],
            'post__in different order'                     => [
                'query_vars1' => [ 'post__in' => [ 1, 2, 3, 4, 5 ] ],
                'query_vars2' => [ 'post__in' => [ 5, 4, 3, 2, 1 ] ],
            ],
            'post__in non-unique'                          => [
                'query_vars1' => [ 'post__in' => [ 1, 2, 3, 4, 5 ] ],
                'query_vars2' => [ 'post__in' => [ 1, 2, 3, 4, 5, 1, 2, 3 ] ],
            ],
            'post_parent__in different order'              => [
                'query_vars1' => [ 'post_parent__in' => [ 1, 2, 3, 4, 5 ] ],
                'query_vars2' => [ 'post_parent__in' => [ 5, 4, 3, 2, 1 ] ],
            ],
            'post_parent__in non-unique'                   => [
                'query_vars1' => [ 'post_parent__in' => [ 1, 2, 3, 4, 5 ] ],
                'query_vars2' => [ 'post_parent__in' => [ 1, 2, 3, 4, 5, 1, 2, 3 ] ],
            ],
            'post_name__in different order'                => [
                'query_vars1' => [ 'post_name__in' => [ 'elphaba', 'glinda', 'the-wizard-of-oz', 'doctor-dillamond' ] ],
                'query_vars2' => [ 'post_name__in' => [ 'doctor-dillamond', 'elphaba', 'the-wizard-of-oz', 'glinda' ] ],
            ],
            'post_name__in non-unique'                     => [
                'query_vars1' => [ 'post_name__in' => [ 'elphaba', 'glinda', 'the-wizard-of-oz', 'doctor-dillamond' ] ],
                'query_vars2' => [ 'post_name__in' => [ 'elphaba', 'glinda', 'elphaba', 'glinda', 'the-wizard-of-oz', 'doctor-dillamond' ] ],
            ],
            'cat different order (array)'                  => [
                'query_vars_1' => [ 'cat' => [ '1', '2' ] ],
                'query_vars_2' => [ 'cat' => [ '2', '1' ] ],
            ],
            'cat different order (string)'                 => [
                'query_vars_1' => [ 'cat' => '2,1' ],
                'query_vars_2' => [ 'cat' => '1,2' ],
            ],
            'cat queries int vs string'                    => [
                'query_vars_1' => [ 'cat' => '2' ],
                'query_vars_2' => [ 'cat' => 2 ],
            ],
            'category__in queries different order (array)' => [
                'query_vars_1' => [ 'category__in' => [ '1', '2' ] ],
                'query_vars_2' => [ 'category__in' => [ '2', '1' ] ],
            ],
            'category__in queries with non-unique array'   => [
                'query_vars_1' => [ 'category__in' => [ '1', '1' ] ],
                'query_vars_2' => [ 'category__in' => [ '1' ] ],
            ],
            'category__in queries string vs array (array)' => [
                'query_vars_1' => [ 'category__in' => [ '1' ] ],
                'query_vars_2' => [ 'category__in' => [ 1 ] ],
            ],
            'category__not_in different order (array)'     => [
                'query_vars_1' => [ 'category__not_in' => [ '1', '2' ] ],
                'query_vars_2' => [ 'category__not_in' => [ '2', '1' ] ],
            ],
            'category__not_in with non-unique array'       => [
                'query_vars_1' => [ 'category__not_in' => [ '1', '1' ] ],
                'query_vars_2' => [ 'category__not_in' => [ '1' ] ],
            ],
            'category__not_in queries string vs array (array)' => [
                'query_vars_1' => [ 'category__not_in' => [ '1' ] ],
                'query_vars_2' => [ 'category__not_in' => [ 1 ] ],
            ],
            'category__and queries width different order (array)' => [
                'query_vars_1' => [ 'category__and' => [ '1', '2' ] ],
                'query_vars_2' => [ 'category__and' => [ '2', '1' ] ],
            ],
            'category__and with non-unique array'          => [
                'query_vars_1' => [ 'category__and' => [ '1', '1', '2' ] ],
                'query_vars_2' => [ 'category__and' => [ '1', '2' ] ],
            ],
            'category__and queries string vs array (array)' => [
                'query_vars_1' => [ 'category__and' => [ '1', '2' ] ],
                'query_vars_2' => [ 'category__and' => [ 1, 2 ] ],
            ],
            'author queries different order (string)'      => [
                'query_vars_1' => [ 'author' => '1,2' ],
                'query_vars_2' => [ 'author' => '2,1' ],
            ],
            'author with non-unique string'                => [
                'query_vars_1' => [ 'author' => '1,1' ],
                'query_vars_2' => [ 'author' => '1' ],
            ],
            'author queries int vs string (string)'        => [
                'query_vars_1' => [ 'author' => 1 ],
                'query_vars_2' => [ 'author' => '1' ],
            ],
            'author queries int vs string (array)'         => [
                'query_vars_1' => [ 'author' => [ 1 ] ],
                'query_vars_2' => [ 'author' => [ '1' ] ],
            ],
            'author__in different order'                   => [
                'query_vars_1' => [ 'author__in' => [ 1, 2 ] ],
                'query_vars_2' => [ 'author__in' => [ 2, 1 ] ],
            ],
            'author__in with non-unique array'             => [
                'query_vars_1' => [ 'author__in' => [ 1, 1, 2 ] ],
                'query_vars_2' => [ 'author__in' => [ 1, 2 ] ],
            ],
            'author__in queries int vs string (array)'     => [
                'query_vars_1' => [ 'author__in' => [ 1 ] ],
                'query_vars_2' => [ 'author__in' => [ '1' ] ],
            ],
            'author__not_in different order (array)'       => [
                'query_vars_1' => [ 'author__not_in' => [ 1, 2 ] ],
                'query_vars_2' => [ 'author__not_in' => [ 2, 1 ] ],
            ],
            'author__not_in queries int vs string (array)' => [
                'query_vars_1' => [ 'author__not_in' => [ 1 ] ],
                'query_vars_2' => [ 'author__not_in' => [ '1' ] ],
            ],
            'tag_slug__in order'                           => [
                'query_vars_1' => [ 'tag_slug__in' => [ 'foo', 'bar' ] ],
                'query_vars_2' => [ 'tag_slug__in' => [ 'bar', 'foo' ] ],
            ],
            'tag_slug__in non-unique vs unique'            => [
                'query_vars_1' => [ 'tag_slug__in' => [ 'foo', 'bar', 'bar' ] ],
                'query_vars_2' => [ 'tag_slug__in' => [ 'foo', 'bar' ] ],
            ],
            'tag_slug__and order'                          => [
                'query_vars_1' => [ 'tag_slug__and' => [ 'foo', 'bar' ] ],
                'query_vars_2' => [ 'tag_slug__and' => [ 'bar', 'foo' ] ],
            ],
            'tag_slug__and non-unique'                     => [
                'query_vars_1' => [ 'tag_slug__and' => [ 'foo', 'bar', 'foo' ] ],
                'query_vars_2' => [ 'tag_slug__and' => [ 'bar', 'foo' ] ],
            ],
            'tag__in queries different order (array)'      => [
                'query_vars_1' => [ 'tag__in' => [ 1, 2 ] ],
                'query_vars_2' => [ 'tag__in' => [ 2, 1 ] ],
            ],
            'tag__in queries non-unique array'             => [
                'query_vars_1' => [ 'tag__in' => [ 1, 2, 1 ] ],
                'query_vars_2' => [ 'tag__in' => [ 2, 1 ] ],
            ],
            'tag__in queries int vs string'                => [
                'query_vars_1' => [ 'tag__in' => [ 2, 1 ] ],
                'query_vars_2' => [ 'tag__in' => [ '2', '1' ] ],
            ],
            'tag__and queries different order (array)'     => [
                'query_vars_1' => [ 'tag__and' => [ 1, 2 ] ],
                'query_vars_2' => [ 'tag__and' => [ 2, 1 ] ],
            ],
            'tag__and queries non-unique array'            => [
                'query_vars_1' => [ 'tag__and' => [ 1, 2, 2 ] ],
                'query_vars_2' => [ 'tag__and' => [ 2, 1 ] ],
            ],
            'tag__not_in queries different order (array)'  => [
                'query_vars_1' => [ 'tag__not_in' => [ 1, 2 ] ],
                'query_vars_2' => [ 'tag__not_in' => [ 2, 1 ] ],
            ],
            'tag__not_in queries non-unique array'         => [
                'query_vars_1' => [ 'tag__not_in' => [ 1, 2, 2 ] ],
                'query_vars_2' => [ 'tag__not_in' => [ 1, 2 ] ],
            ],
            'tag__not_in queries int vs string (array)'    => [
                'query_vars_1' => [ 'tag__not_in' => [ '1' ] ],
                'query_vars_2' => [ 'tag__not_in' => [ 1 ] ],
            ],
            'cache parameters'                             => [
                'query_vars1' => [
