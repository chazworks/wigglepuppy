...
class Tests_Query_MetaQuery extends WP_UnitTestCase
{
    ...
    public function test_meta_between_not_between()
    {
        ...
        $posts = wp_list_pluck($query->posts, 'ID');
        $this->assertSameSets([ $post_id, $post_id4, $post_id5 ], $posts);
    }
    ...
    public function test_meta_default_compare()
    {
        ...
        $this->assertSameSets([ $post_id, $post_id3 ], $posts);
    ...
    public function test_duplicate_posts_when_no_key()
    {
        ...
        $posts = wp_list_pluck($posts, 'ID');
        $this->assertSameSets([ $post_id, $post_id2 ], $posts);
    }
    ...
    public function test_empty_meta_value()
    {
        ...
        $posts = wp_list_pluck($posts, 'ID');
        $this->assertSameSets([ $post_id, $post_id5 ], $posts);
        ...
        $posts = wp_list_pluck($posts, 'ID');
        $this->assertSameSets([ $post_id, $post_id3, $post_id4, $post_id5, $post_id6 ], $posts);
