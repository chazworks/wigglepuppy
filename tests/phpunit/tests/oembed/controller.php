...
class Test_oEmbed_Controller extends WP_UnitTestCase
{
    ...
    public const YOUTUBE_VIDEO_ID       = 'OQSNhk5ICTI';
    public const INVALID_OEMBED_URL     = 'https://www.notreallyanoembedprovider.com/watch?v=awesome-cat-video';
    public const UNTRUSTED_PROVIDER_URL = 'https://www.untrustedprovider.com';
    ...
    public function test_wp_oembed_ensure_format()
    {
        ...
        $this->assertSame('json', wp_oembed_ensure_format([]));
    }
    ...
    public function test_rest_pre_serve_request()
    {
        ...
        $response = rest_get_server()->dispatch($request);
        $output   = get_echo('_oembed_rest_pre_serve_request', [ true, $response, $request, rest_get_server() ]);
