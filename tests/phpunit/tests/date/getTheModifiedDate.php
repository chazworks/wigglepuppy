...
class Tests_Date_GetTheModifiedDate extends WP_UnitTestCase
{
    ...
    public function test_get_the_modified_date_failures_are_filtered()
    {
        ...
        add_filter('get_the_modified_date', [ $this, '_filter_get_the_modified_date_failure' ]);
        $actual = get_the_modified_date();
        $this->assertSame($expected, $actual);
        remove_filter('get_the_modified_date', [ $this, '_filter_get_the_modified_date_failure' ]);
    }
    ...
    {
        $post_id = self::factory()->post->create([ 'post_date' => '2020-08-31 23:14:00' ]);
    ...
    public function test_get_the_modified_time_failures_are_filtered()
    {
        ...
        add_filter('get_the_modified_time', [ $this, '_filter_get_the_modified_time_failure' ]);
        $actual = get_the_modified_time();
        $this->assertSame($expected, $actual);
        remove_filter('get_the_modified_time', [ $this, '_filter_get_the_modified_time_failure' ]);
    }
