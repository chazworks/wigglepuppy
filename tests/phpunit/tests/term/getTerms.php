...
class Tests_Term_getTerms extends WP_UnitTestCase
{
    ...
    public function set_up()
    {
        ...
        register_taxonomy(self::$taxonomy, 'post', [ 'hierarchical' => true ]);
    ...
    {
        register_taxonomy(self::$taxonomy, 'page', [ 'hierarchical' => true ]);
        ...
        $posts    = $factory->post->create_many(3, [ 'post_type' => 'page' ]);
        foreach ($posts as $i => $post) {
            wp_set_object_terms($post, [ $term_id1, $term_id2 ], self::$taxonomy);
        }
    }
    ...
    public function test_meta_query_args_only()
    {
        ...
        $term1 = self::factory()->term->create([ 'taxonomy' => 'wptests_tax' ]);
        $term2 = self::factory()->term->create([ 'taxonomy' => 'wptests_tax' ]);

        $post = self::factory()->post->create([ 'post_type' => 'post' ]);

        update_term_meta($term1, 'somekey', 'thevalue');

        wp_set_post_terms($post, [ $term1, $term2 ], 'wptests_tax');
        ...
        $this->assertSameSets([ $term1 ], wp_list_pluck($found, 'term_id'));
    }
    ...
    public function test_should_accept_an_args_array_containing_taxonomy_for_first_parameter()
    {
        ...
        $term = self::factory()->term->create([ 'taxonomy' => 'wptests_tax' ]);
        ...
        $this->assertSameSets([ $term ], $found);
    }
    ...
    public function test_get_terms_cache()
    {
        ...
        $terms = get_terms('post_tag', [ 'update_term_meta_cache' => false ]);
    ...
    public function test_get_terms_cache_should_be_missed_when_passing_number()
    {
        ...
        $terms = get_terms('post_tag', [ 'number' => 2 ]);
    ...
    public function test_get_terms_should_allow_arbitrary_indexed_taxonomies_array()
    {
        ...
        $terms   = get_terms([ '111' => 'post_tag' ], [ 'hide_empty' => false ]);
    ...
    public function test_get_terms_fields()
    {
        ...
        $this->assertSameSets([ $term_id1, $term_id2 ], $terms_ids);
        ...
        $this->assertSameSets([ 'WOO!', 'HOO!' ], $terms_name);
    ...
    public function test_get_terms_include_exclude()
    {
        ...
        $inc_terms = get_terms(
            'post_tag',
            [
                'include'    => [ $term_id1, $term_id2 ],
                'hide_empty' => false,
            ],
        );
        $this->assertSame([ $term_id1, $term_id2 ], wp_list_pluck($inc_terms, 'term_id'));

        $exc_terms = get_terms(
            'post_tag',
            [
                'exclude'    => [ $term_id1, $term_id2 ],
                'hide_empty' => false,
            ],
        );
        $this->assertSame([], wp_list_pluck($exc_terms, 'term_id'));
    ...
    public function test_exclude_with_hierarchical_true_for_non_hierarchical_taxonomy()
    {
        ...
        $found = get_terms(
            ...
            [
                'taxonomy'     => 'wptests_tax',
                'hide_empty'   => false,
                'exclude_tree' => [ $terms[0] ],
                'hierarchical' => true,
            ],
        );

        $this->assertSame([ $terms[1] ], wp_list_pluck($found, 'term_id'));
    ...
    public function test_get_terms_exclude_tree()
    {
        ...
        $term_id11 = self::factory()->category->create([ 'parent' => $term_id1 ]);
        $term_id2  = self::factory()->category->create();
        $term_id22 = self::factory()->category->create([ 'parent' => $term_id2 ]);
        ...
        $this->assertSame([ $term_id1, $term_id11, $term_id2, $term_id22 ], $terms);
        ...
        $this->assertSame([ $term_id2, $term_id22 ], $terms);
    }
    ...
    {
        $term_id1 = self::factory()->tag->create([ 'slug' => 'burrito' ]);
        $term_id2 = self::factory()->tag->create([ 'name' => 'Wilbur' ]);
        $term_id3 = self::factory()->tag->create([ 'name' => 'Foo' ]);
        ...
        $this->assertSameSets([ $term_id1, $term_id2 ], $terms);
    }
    ...
    public function test_get_terms_like()
    {
        ...
        $this->assertSameSets([ $term_id1 ], $terms);
        ...
        $this->assertSameSets([ $term_id1, $term_id2 ], $terms2);
        ...
        $this->assertSameSets([ $term_id1 ], $terms3);
        ...
        $this->assertSameSets([ $term_id1, $term_id2 ], $terms4);
        ...
        $this->assertSameSets([ $term_id1, $term_id2 ], $terms7);
        ...
        $this->assertSameSets([ $term_id1, $term_id2 ], $terms8);
    }
    ...
    public function test_get_terms_parent_zero()
    {
        ...
        $this->assertCount(2, $terms);
        $this->assertSame(wp_list_pluck($terms, 'name'), [ 'Cheese', 'Crackers' ]);
    }
    ...
    public function test_get_terms_grandparent_zero()
    {
        ...
        $this->assertSame([ 'Cheese' ], wp_list_pluck($terms, 'name'));
    ...
    public function test_get_terms_seven_levels_deep()
    {
        ...
        $this->assertCount(1, $terms);
        $this->assertSame([ 'term1' ], wp_list_pluck($terms, 'name'));
    ...
    {
        $parent = self::factory()->category->create();
        self::factory()->category->create([ 'parent' => $parent ]);
    ...
    {
        register_taxonomy('wptests_tax1', 'post', [ 'hierarchical' => true ]);
        register_taxonomy('wptests_tax2', 'post', [ 'hierarchical' => true ]);
    ...
    public function test_get_term_children_recursion()
    {
        ...
        $term = wp_update_term($term['term_id'], 'category', [ 'parent' => $term['term_id'] ]);
    ...
    public function test__get_term_children_handles_cycles()
    {
        ...
        $c2 = self::factory()->category->create([ 'parent' => $c1 ]);
        $c3 = self::factory()->category->create([ 'parent' => $c2 ]);
        wp_update_term($c1, 'category', [ 'parent' => $c3 ]);

        add_filter('wp_update_term_parent', 'wp_check_term_hierarchy_for_loops', 10, 3);

        $result = _get_term_children($c1, [ $c1, $c2, $c3 ], 'category');

        $this->assertSameSets([ $c2, $c3 ], $result);
    }
    ...
    public function test__get_term_children_handles_cycles_when_terms_argument_contains_objects()
    {
        ...
        $c2 = self::factory()->category->create_and_get([ 'parent' => $c1->term_id ]);
        $c3 = self::factory()->category->create_and_get([ 'parent' => $c2->term_id ]);
        wp_update_term($c1->term_id, 'category', [ 'parent' => $c3->term_id ]);

        add_filter('wp_update_term_parent', 'wp_check_term_hierarchy_for_loops', 10, 3);

        $result = _get_term_children($c1->term_id, [ $c1, $c2, $c3 ], 'category');
    ...
    {
        $t1 = self::factory()->tag->create([ 'slug' => 'foo' ]);
        $t2 = self::factory()->tag->create([ 'slug' => 'bar' ]);
    ...
    public function test_get_terms_by_multiple_slugs()
    {
        $t1 = self::factory()->tag->create([ 'slug' => 'foo' ]);
        $t2 = self::factory()->tag->create([ 'slug' => 'bar' ]);
        $t3 = self::factory()->tag->create([ 'slug' => 'barry' ]);
    ...
    {
        $t1 = self::factory()->tag->create([ 'name' => 'Foo' ]);
        $t2 = self::factory()->tag->create([ 'name' => 'Bar' ]);
    ...
    public function test_get_terms_by_multiple_names()
    {
        $t1 = self::factory()->tag->create([ 'name' => 'Foo' ]);
        $t2 = self::factory()->tag->create([ 'name' => 'Bar' ]);
        $t3 = self::factory()->tag->create([ 'name' => 'Barry' ]);
        ...
        $this->assertSameSets([ $t3, $t1 ], $found);
    }
    ...
    public function test_childless_should_return_all_terms_for_flat_hierarchy()
    {
        ...
        $flat_tax = 'countries';
        register_taxonomy($flat_tax, 'post', [ 'hierarchical' => false ]);
        ...
        $expected = [ $australia, $china, $tanzania ];
    ...
    public function test_childless_hierarchical_taxonomy()
    {
        ...
        */
        ...
        $this->assertSameSets([ $montreal, $nepean, $toronto, $pei ], $terms);
    }
    ...
    public function test_childless_hierarchical_taxonomy_used_with_child_of()
    {
        ...
        $this->assertSameSets([ $laval ], $terms);
    }
    ...
    public function test_childless_should_enforce_childless_status_for_all_queried_taxonomies()
    {
        ...
        $this->assertSameSets([ $t2, $t4 ], $found);
    }
    ...
    public function test_hierarchical_should_recurse_properly_for_all_taxonomies()
    {
        ...
        $t4 = self::factory()->term->create([ 'taxonomy' => 'wptests_tax2' ]);
    ...
    public function test_orderby_include()
    {
        ...
        $t1 = self::factory()->term->create([ 'taxonomy' => $tax ]);
        $t2 = self::factory()->term->create([ 'taxonomy' => $tax ]);
        $t3 = self::factory()->term->create([ 'taxonomy' => $tax ]);
        $t4 = self::factory()->term->create([ 'taxonomy' => $tax ]);
        ...
        $this->assertSame([ $t4, $t1, $t2 ], $found);
    }
    ...
    public function test_orderby_description()
    {
        ...
        $this->assertSame([ $t2, $t1, $t4, $t3 ], $found);
    }
    ...
    public function test_orderby_term_id()
    {
        ...
        $this->assertSame([ $t1, $t2, $t3 ], $found);
    }
    ...
    public function test_orderby_meta_value()
    {
        ...
        $this->assertSameSets([ $terms[1], $terms[2], $terms[0] ], $found);
    }
    ...
    public function test_orderby_meta_value_with_meta_key()
    {
        ...
        $this->assertSameSets([ $terms[1], $terms[0], $terms[2] ], $found);
    }
    ...
    {
        register_taxonomy('wptests_tax_1', 'post', [ 'hierarchical' => true ]);
        ...
        wp_set_object_terms($posts[0], [ $t1 ], 'wptests_tax_1');
        wp_set_object_terms($posts[1], [ $t2 ], 'wptests_tax_1');
        wp_set_object_terms($posts[2], [ $t3 ], 'wptests_tax_1');
        ...
        $this->assertSameSets([ $t1, $t2, $t3 ], wp_list_pluck($found, 'term_id'));
    ...
    public function test_pad_counts_cached()
    {
        ...
        $this->assertSameSets([ $t1, $t2, $t3 ], wp_list_pluck($found, 'term_id'), 'Check to see if results are as expected');
        ...
        $this->assertSameSets([ $t1, $t2, $t3 ], wp_list_pluck($found, 'term_id'), 'Check to see if results are as expected on second run');
    ...
    public function test_pad_counts_should_not_recurse_infinitely_when_term_hierarchy_has_a_loop()
    {
        ...
        $this->assertSameSets([ $c1, $c2, $c3 ], wp_list_pluck($terms, 'term_id'));
    ...
    {
        register_taxonomy('wptests_tax1', 'post', [ 'hierarchical' => false ]);
        register_taxonomy('wptests_tax2', 'post', [ 'hierarchical' => true ]);
    ...
    {
        register_taxonomy('wptests_tax', 'post');
        $terms = self::factory()->term->create_many(1, [ 'taxonomy' => 'wptests_tax' ]);
        add_term_meta($terms[0], 'foo', 'bar');
    ...
    public function test_indexes_should_not_be_reset_when_number_of_matched_terms_is_greater_than_number()
    {
        ...
        $this->assertSame([ $terms[0], $terms[1] ], array_keys($found));
    }
    ...
    {
        add_filter('get_terms', [ __CLASS__, 'maybe_filter_count' ]);
        ...
        remove_filter('get_terms', [ __CLASS__, 'maybe_filter_count' ]);
    ...
    public function test_with_term_slug_equal_to_string_0()
    {
        ...
        $this->assertSameSets([ $term_id ], wp_list_pluck($found, 'term_id'));
    }
    ...
    public function test_cache_key_generation_cache_domain()
    {
        ...
        $args_2        = array_merge($args_1, [ 'cache_domain' => microtime() ]);
    ...
    public function test_cache_key_generation_all_with_object_id()
    {
        ...
        $args_2        = array_merge($args_1, [ 'fields' => 'all_with_object_id' ]);
        $query1        = get_terms($args_1);
        $num_queries_1 = get_num_queries();
        $query2        = get_terms($args_2);
        $this->assertNotSame($num_queries_1, get_num_queries());
    ...
    public function data_same_term_args()
    {
        return [
            ...
            'array taxonomy vs string taxonomy'        => [
                [
                    'taxonomy' => self::$taxonomy,
                    'fields'   => 'all',
                ],
            ...
            'array object_ids vs string object_ids'    => [
                [
                    'taxonomy'   => self::$taxonomy,
                    'fields'     => 'all',
                    'object_ids' => '',
            ...
            'array term_taxonomy_id vs string term_taxonomy_id' => [
                [
                    'taxonomy'         => self::$taxonomy,
                    'fields'           => 'ids',
                    'term_taxonomy_id' => '',
            ...
            'array exclude vs string exclude'          => [
                [
                    'taxonomy' => self::$taxonomy,
                    'fields'   => 'ids',
                    'exclude'  => '',
            ...
            'array include vs string include'          => [
                [
                    'taxonomy' => self::$taxonomy,
                    'fields'   => 'ids',
                    'include'  => '',
            ...
            'int object_ids vs array object_ids'       => [
                [
                    'taxonomy'   => self::$taxonomy,
                    'fields'     => 'ids',
                    'object_ids' => 1,
            ...
            'string object_ids vs array object_ids'    => [
                [
                    'taxonomy'   => self::$taxonomy,
                    'fields'     => 'ids',
                    'object_ids' => '1',
            ...
            'int term_taxonomy_id vs array term_taxonomy_id and fields different' => [
                [
                    'taxonomy'         => self::$taxonomy,
                    'fields'           => 'ids',
                    'term_taxonomy_id' => 1,
            ...
            'same arguments in a different order'      => [
                [
                    'fields'           => 'ids',
                    'taxonomy'         => self::$taxonomy,
                    'term_taxonomy_id' => 1,
            ...
            'invalid arguments discarded in cache key' => [
                [
                    'fields'           => 'ids',
                    'taxonomy'         => self::$taxonomy,
                    'term_taxonomy_id' => 1,
    ...
    public function test_with_multiple_term_slugs_one_equal_to_string_0()
    {
        ...
        $this->assertSameSets([ $term_id1, $term_id2 ], wp_list_pluck($found, 'term_id'));
    }
    ...
    protected function create_hierarchical_terms()
    {
        ...
        wp_set_post_terms($first_post_id, [ $three_term['term_id'] ], 'category');
        wp_set_post_terms($second_post_id, [ $six_term['term_id'] ], 'category');
