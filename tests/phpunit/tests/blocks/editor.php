...
class Tests_Blocks_Editor extends WP_UnitTestCase
{
    ...
    {
        $context = new WP_Block_Editor_Context([ 'post' => get_post() ]);
    ...
    {
        $context = new WP_Block_Editor_Context([ 'name' => 'core/edit-widgets' ]);
    ...
    {
        $context = new WP_Block_Editor_Context([ 'name' => 'core/customize-widgets' ]);
    ...
    {
        add_filter('allowed_block_types', [ $this, 'filter_set_allowed_block_types_post' ], 10, 2);

        $post_editor_context = new WP_Block_Editor_Context([ 'post' => get_post() ]);
        $allowed_block_types = get_allowed_block_types($post_editor_context);

        remove_filter('allowed_block_types', [ $this, 'filter_set_allowed_block_types_post' ]);

        $this->assertSameSets([ 'test/filtered-block' ], $allowed_block_types);
    }
    ...
    public function test_get_block_editor_settings_overrides_default_settings_all_editors()
    {
        ...
        $this->assertSameSets([ 'test/filtered-my-block' ], $settings['allowedBlockTypes']);
        $this->assertSameSets(
            [
                [
                    'slug'  => 'filtered-my-category',
    ...
    public function test_wp_get_first_block()
    {
        ...
        $this->assertSame([], wp_get_first_block($blocks_with_no_paragraph, $block_name));
    }
    ...
    public function test_wp_get_post_content_block_attributes_no_layout()
    {
        ...
        $this->assertSame([], wp_get_post_content_block_attributes());
    }
    ...
    public function test_get_block_editor_settings_theme_json_settings()
    {
        ...
        $this->assertSameSets([ 'rem' ], $settings['enableCustomUnits']);
    ...
    public function test_block_editor_rest_api_preload_no_paths()
    {
        ...
        block_editor_rest_api_preload([], $editor_context);
    ...
    public function test_block_editor_rest_api_preload_filter_all()
    {
        function filter_add_preload_paths($preload_paths, WP_Block_Editor_Context $context)
        {
            if (empty($context->post)) {
                array_push($preload_paths, [ '/wp/v2/types', 'OPTIONS' ]);
            }
