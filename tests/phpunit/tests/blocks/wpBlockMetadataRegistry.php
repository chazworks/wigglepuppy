...
class Tests_Blocks_WpBlockMetadataRegistry extends WP_UnitTestCase
{
    ...
    public function test_with_windows_paths()
    {
        ...
        $this->assertSame([ wp_normalize_path($block_path) ], WP_Block_Metadata_Registry::get_collection_block_metadata_files($plugin_path), 'Could not get correct list of block.json paths for collection.');
    }
