...
class Tests_Formatting_EscTextarea extends WP_UnitTestCase
{
    ...
    {
        add_filter('pre_option_blog_charset', [ $this, 'charset_iso_8859_1' ]);
        $iso8859_1 = 'Fran' . chr(135) . 'ais';
        $this->assertSame($iso8859_1, esc_textarea($iso8859_1));
        remove_filter('pre_option_blog_charset', [ $this, 'charset_iso_8859_1' ]);
    }
    ...
    {
        add_filter('pre_option_blog_charset', [ $this, 'charset_utf_8' ]);
        $utf8 = 'Fran' . chr(195) . chr(167) . 'ais';
        $this->assertSame($utf8, esc_textarea($utf8));
        remove_filter('pre_option_blog_charset', [ $this, 'charset_utf_8' ]);
    }
}
