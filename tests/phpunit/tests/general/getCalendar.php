...
class Tests_General_GetCalendar extends WP_UnitTestCase
{
    ...
    {
        $calendar_html = get_echo('get_calendar', [ [ 'display' => true ] ]);
    ...
    {
        $calendar_html = get_echo('get_calendar', [ [ 'post_type' => 'page' ] ]);
    ...
    {
        $first_calendar_html  = get_echo('get_calendar', [ [ 'initial' => true ] ]);
        $second_calendar_html = get_echo('get_calendar', [ [ 'initial' => false ] ]);
    ...
    public function test_get_calendar_caching_accounts_for_args()
    {
        ...
        $second_calendar_html = get_echo('get_calendar', [ [ 'post_type' => 'page' ] ]);
    ...
    {
        get_echo('get_calendar', [ [ 'post_type' => 'page' ] ]);
    ...
    {
        $first_calendar_html = get_echo('get_calendar', [ false ]);
