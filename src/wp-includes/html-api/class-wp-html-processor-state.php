...
class WP_HTML_Processor_State
{
     ...
     * @var string
     */
    public const INSERTION_MODE_BEFORE_HTML = 'insertion-mode-before-html';
     ...
     * @var string
     */
    public const INSERTION_MODE_BEFORE_HEAD = 'insertion-mode-before-head';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_HEAD = 'insertion-mode-in-head';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_HEAD_NOSCRIPT = 'insertion-mode-in-head-noscript';
     ...
     * @var string
     */
    public const INSERTION_MODE_AFTER_HEAD = 'insertion-mode-after-head';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_TABLE = 'insertion-mode-in-table';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_TABLE_TEXT = 'insertion-mode-in-table-text';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_CAPTION = 'insertion-mode-in-caption';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_COLUMN_GROUP = 'insertion-mode-in-column-group';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_TABLE_BODY = 'insertion-mode-in-table-body';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_ROW = 'insertion-mode-in-row';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_CELL = 'insertion-mode-in-cell';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_SELECT = 'insertion-mode-in-select';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_SELECT_IN_TABLE = 'insertion-mode-in-select-in-table';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_TEMPLATE = 'insertion-mode-in-template';
     ...
     * @var string
     */
    public const INSERTION_MODE_AFTER_BODY = 'insertion-mode-after-body';
     ...
     * @var string
     */
    public const INSERTION_MODE_IN_FRAMESET = 'insertion-mode-in-frameset';
     ...
     * @var string
     */
    public const INSERTION_MODE_AFTER_FRAMESET = 'insertion-mode-after-frameset';
     ...
     * @var string
     */
    public const INSERTION_MODE_AFTER_AFTER_BODY = 'insertion-mode-after-after-body';
     ...
     * @var string
     */
    public const INSERTION_MODE_AFTER_AFTER_FRAMESET = 'insertion-mode-after-after-frameset';
