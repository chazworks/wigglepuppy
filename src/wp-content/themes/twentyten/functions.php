...
function twentyten_scripts_styles()
{
    ...
    wp_enqueue_style('twentyten-block-style', get_template_directory_uri() . '/blocks.css', [], '20250220');
}
...
{
    // Block styles.
    wp_enqueue_style('twentyten-block-editor-style', get_template_directory_uri() . '/editor-blocks.css', [], '20240703');
}
