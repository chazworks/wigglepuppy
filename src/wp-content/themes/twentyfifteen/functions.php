...
function twentyfifteen_scripts()
{
    ...
    wp_enqueue_style('twentyfifteen-style', get_stylesheet_uri(), [], '20250415');

    // Theme block stylesheet.
    wp_enqueue_style('twentyfifteen-block-style', get_template_directory_uri() . '/css/blocks.css', [ 'twentyfifteen-style' ], '20240715');
...
{
    // Block styles.
    wp_enqueue_style('twentyfifteen-block-editor-style', get_template_directory_uri() . '/css/editor-blocks.css', [], '20240720');
    // Add custom fonts.
    $font_version = (0 === strpos((string) twentyfifteen_fonts_url(), get_template_directory_uri() . '/')) ? '20230328' : null;
    wp_enqueue_style('twentyfifteen-fonts', twentyfifteen_fonts_url(), [], $font_version);
}
