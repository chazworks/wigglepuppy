...
function twentysixteen_scripts()
{
    ...
    // Theme stylesheet.
    wp_enqueue_style('twentysixteen-style', get_stylesheet_uri(), [], '20250415');

    // Theme block stylesheet.
    wp_enqueue_style('twentysixteen-block-style', get_template_directory_uri() . '/css/blocks.css', [ 'twentysixteen-style' ], '20240817');
...
{
    // Block styles.
    wp_enqueue_style('twentysixteen-block-editor-style', get_template_directory_uri() . '/css/editor-blocks.css', [], '20241202');
    // Add custom fonts.
    $font_version = (0 === strpos((string) twentysixteen_fonts_url(), get_template_directory_uri() . '/')) ? '20230328' : null;
    wp_enqueue_style('twentysixteen-fonts', twentysixteen_fonts_url(), [], $font_version);
}
