...
function twentyfourteen_scripts()
{
    ...
    wp_enqueue_style('twentyfourteen-style', get_stylesheet_uri(), [], '20250415');

    // Theme block stylesheet.
    wp_enqueue_style('twentyfourteen-block-style', get_template_directory_uri() . '/css/blocks.css', [ 'twentyfourteen-style' ], '20240708');
...
{
    // Block styles.
    wp_enqueue_style('twentyfourteen-block-editor-style', get_template_directory_uri() . '/css/editor-blocks.css', [], '20240716');
    // Add custom fonts.
    $font_version = (0 === strpos((string) twentyfourteen_font_url(), get_template_directory_uri() . '/')) ? '20230328' : null;
