...
function twentyeleven_scripts_styles()
{
    ...
    wp_enqueue_style('twentyeleven-block-style', get_template_directory_uri() . '/blocks.css', [], '20240703');
}
...
{
    // Block styles.
    wp_enqueue_style('twentyeleven-block-editor-style', get_template_directory_uri() . '/editor-blocks.css', [], '20240716');
}
