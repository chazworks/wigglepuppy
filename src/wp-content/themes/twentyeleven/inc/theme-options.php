...
function twentyeleven_enqueue_color_scheme()
{
    ...
    if ('dark' === $color_scheme) {
        wp_enqueue_style('dark', get_template_directory_uri() . '/colors/dark.css', [], '20240603');
    }
...
{
    wp_enqueue_script('twentyeleven-customizer', get_template_directory_uri() . '/inc/theme-customizer.js', [ 'customize-preview' ], '20250217', [ 'in_footer' => true ]);
}
