...
function twentytwelve_scripts_styles()
{
    ...
    wp_enqueue_style('twentytwelve-style', get_stylesheet_uri(), [], '20250415');

    // Theme block stylesheet.
    wp_enqueue_style('twentytwelve-block-style', get_template_directory_uri() . '/css/blocks.css', [ 'twentytwelve-style' ], '20240812');

    // Loads the Internet Explorer specific stylesheet.
    wp_enqueue_style('twentytwelve-ie', get_template_directory_uri() . '/css/ie.css', [ 'twentytwelve-style' ], '20240722');
...
{
    // Block styles.
    wp_enqueue_style('twentytwelve-block-editor-style', get_template_directory_uri() . '/css/editor-blocks.css', [], '20240811');
    // Add custom fonts.
    $font_version = (0 === strpos((string) twentytwelve_get_font_url(), get_template_directory_uri() . '/')) ? '20230328' : null;
...
{
    wp_enqueue_script('twentytwelve-customizer', get_template_directory_uri() . '/js/theme-customizer.js', [ 'customize-preview' ], '20250217', [ 'in_footer' => true ]);
}
